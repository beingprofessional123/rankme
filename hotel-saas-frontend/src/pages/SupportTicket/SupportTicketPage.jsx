                    ...
                    return (
                        <div className="tdaction">
                            <Link to={`/support-tickets-view/${value}`} state={{ data: rowData }}>
                                <img src={viewsvg} className="img-fluid" alt="view" />
                            </Link>
                        ...
                        <div className="col-md-6">
                            <div className="breadcrumb-right">
                                <Link to="/support-tickets-add" className="btn btn-info">
                                    <img src={roomadsvg} className="img-fluid" alt="Add Ticket" /> Ticket
                                </Link>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div className="form-design text-center">
                                    <img src={failedsvg} className="img-fluid mb-3" alt="warning" />
                                    <h3>Delete Ticket</h3>
