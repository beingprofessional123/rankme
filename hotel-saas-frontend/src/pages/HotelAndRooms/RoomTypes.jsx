...
// Assuming you have these SVGs in assets/images/
import addIcon from '../../assets/images/add.svg'; // Make sure this path is correct
import deleteIcon from '../../assets/images/delete.svg'; // Make sure this path is correct
...
const RoomTypes = ({ hotelId }) => {
  ...
  const handleFinish = async () => {
    ...
    if (success) {
      window.location.href = '/hotels-and-rooms'; // Redirect to dashboard
    }
  };
              ...
              <div className="addbtn"> {/* This contains the select and the action button */}
                ...
                {rooms.length > 1 && ( // Only show delete if there's more than one room entry
                  <button
                    ...
                    title="Remove Room"
                  >
                    <img src={deleteIcon} className="img-fluid" alt="Remove" />
                  </button>
                )}
                ...
                {(index === rooms.length - 1 || rooms.length === 0) && (
                    ...
                    >
                        <img src={addIcon} className="img-fluid" alt="Add" />
                    </button>
                )}
              </div>
