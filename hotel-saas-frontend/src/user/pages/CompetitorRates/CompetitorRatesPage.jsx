                        ...
                        <span className={rowData.warning ? 'warningtr-td' : ''}>
                            ...
                            {rowData.warning && (
                                <span style={{ marginLeft: 4 }}>
                                    <img src={`/user/images/warning.svg`} className="img-fluid" alt="Warning" style={{ height: '16px' }} />
                                </span>
                            )}
                        </span>
                    );
                            ...
                            <div id="home2" className="tab-pane fade">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div className="upload-files-container">
                                                <div className="drag-file-area">
                                                    <span className="material-icons-outlined upload-icon"><img src={`/user/images/uploadicon.svg`} className="img-fluid" alt="" /></span>
                                ...
                                <div className="data-uploadtable">
                                    <div className="data-uploadtop">
                                        ...
                                        <span><img src={`/user/images/download.svg`} className="img-fluid" alt="" /></span>
                                    </div>
                                    <div className="tabledesign">
                                        <div className="table-responsive">
                                            <MUIDataTable
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="form-design">
                                <img src={`/user/images/failed.svg`} className="img-fluid" alt="" />
                                <h3>Upload failed</h3>
