        ...
        <div className="container-fluid">
          ...
          <div className="white-bg dataupload">
            ...
            <div className="tab-content">
              {/* Centralized content for all tabs */}
              <div id="uploadContent" className="tab-pane active"> {/* This div will always be active */}
                <form>
                  <div className="form-design">
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      <h4>Upload Your Data</h4>
                      {/* Download Template button moved here to be visible on all tabs */}
                      <button
                          type="button"
