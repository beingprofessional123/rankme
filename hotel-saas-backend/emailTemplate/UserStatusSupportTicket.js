...
const getStatusUpdateEmail = (userName, ticketNumber, subject, newStatus, ticketLink) => {
  const emailSubject = `Ticket #${ticketNumber} Status Updated: ${newStatus}`;
      ...
      <div class="mail-messages-body" style="padding: 20px;background: #eaeaea;">
        ...
        <div class="mail-messages" style="background: #FFFFFF;padding: 30px;">
          ...
          <div class="mail-docu" style="padding: 28px 36px 36px 36px;border-radius: 2px;background: #17237E;text-align: center;margin-bottom: 20px;">
            ...
            <p style="font-weight: 500;font-size: 16px;line-height: 24px;color: #fff;margin-bottom: 22px;margin-top: 0px;">We're writing to inform you that the status of your support ticket has been updated.</p>
            <p style="font-weight: 500;font-size: 16px;line-height: 24px;color: #fff;margin-bottom: 22px;margin-top: 0px;">Ticket Details:</p>
            <ul style="list-style: none; padding: 0; margin: 0; text-align: left; color: #fff;">
                ...
                <li style="margin-bottom: 8px;"><strong>Status:</strong><span style="font-weight: bold; color: ${newStatus === 'Closed' ? '#dc3545' : '#007bff'};">${newStatus}</span></li>
            </ul>
            ...
            <p style="text-align: left; font-weight: 400;font-size: 16px;line-height: 24px;color: #fff;margin-bottom: 0px;margin-top: 10px;">If you have any further questions, please reply to the ticket thread.</p>
          </div>
          <div class="namemail">
